      ...
      <div className="mx-auto max-w-5xl">
        ...
        <section className="mt-8 rounded-[32px] border border-[#E8D5A3] bg-white p-10 shadow-[0_20px_80px_rgba(212,175,55,0.14)]">
          <div className="mb-12 text-center">
            <p className="font-playfair text-[#D4AF37] text-sm uppercase tracking-[0.28em]">Full anniversary letter</p>
            <h1 className="mt-4 font-playfair text-[42px] sm:text-[52px] text-[#3D2C2C]">For our journey so far</h1>
            <p className="mt-4 max-w-2xl mx-auto text-[#8B6E6E] text-base leading-relaxed">
              Every word is given room to breathe, written for the two years we have held each other close.
            </p>
          </div>
