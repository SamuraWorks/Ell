...
import { checkPassword, saveAnniversaryPassword, isAnniversaryPasswordOk, DEV_MODE } from '@/lib/unlock'
...
export function AnniversaryLock({ onUnlock }: AnniversaryLockProps) {
  ...
  // Target: June 24, 12:00 AM of the current year
  const getTargetDate = () => {
    const year = new Date().getFullYear()
    return new Date(year, 5, 24, 0, 0, 0) // Month 5 is June (0-indexed)
  }
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-gradient-to-b from-[#F9E8E8] to-[#F5E6C8] px-6 py-24">
      {/* Background Sparkles */}
      <div className="absolute inset-0 pointer-events-none">
        {Array.from({ length: 25 }).map((_, i) => (
          ...
          >
            <svg width="10" height="10" viewBox="0 0 24 24" fill="#D4AF37" className="opacity-30">
            ...
            >
              ...
              <div className="space-y-4 max-w-md">
                <p className="font-playfair text-[20px] sm:text-[22px] italic text-[#3D2C2C] leading-relaxed">
                  "Some stories deserve the right moment before they are reopened."
                </p>
                <p className="font-jost text-sm tracking-wide text-[#8B6E6E] uppercase">
                  A special chapter has been carefully preserved and is waiting for its time.
                </p>
          ...
          {step === 'countdown' && (
            ...
            >
              ...
              <div className="space-y-3">
                <h2 className="font-playfair text-[32px] text-[#3D2C2C] tracking-tight">Hang tight...</h2>
                <p className="font-jost text-base text-[#6E5250] max-w-sm mx-auto leading-relaxed">
              ...
              <div className="flex flex-col items-center gap-3 pt-4">
                ...
                <p className="font-playfair italic text-[18px] text-[#C4687A]">
                  "The best chapters are worth waiting for."
                </p>
              </div>
            </motion.div>
          )}
          ...
          {step === 'password' && (
            ...
            >
              ...
              <form onSubmit={handlePasswordSubmit} className="w-full max-w-xs space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full rounded-full bg-[#D4AF37] px-8 py-4 font-jost text-sm uppercase tracking-widest text-white shadow-[0_8px_30px_rgba(212,175,55,0.35)] transition-all hover:bg-[#C09B25] hover:shadow-[0_12px_40px_rgba(212,175,55,0.45)] active:scale-95"
                >
                  Enter ✨
                </button>
              </form>
